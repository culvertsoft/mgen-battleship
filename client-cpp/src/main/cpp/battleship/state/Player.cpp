...
const mgen::Field * Player::_fieldByName(const std::string& name) const {
	static const std::map<std::string, const mgen::Field*> name2meta = mgen::make_map<std::string, const mgen::Field*>()("team", &Player::_field_team_metadata())("name", &Player::_field_name_metadata())("ready", &Player::_field_ready_metadata());
...
const std::vector<mgen::Field>& Player::_field_metadatas() {
	static const std::vector<mgen::Field> out = mgen::make_vector<mgen::Field>() << _field_team_metadata() << _field_name_metadata() << _field_ready_metadata();
	return out;
}
