...
public:
	Fire();
	Fire(const battleship::state::Vec2& position);
	virtual ~Fire();
...
public:
	...
	Fire& _setPositionSet(const bool state, const mgen::FieldSetDepth depth);

	Fire& _setAllFieldsSet(const bool state, const mgen::FieldSetDepth depth);
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 6880290600081744688LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = -25434;
