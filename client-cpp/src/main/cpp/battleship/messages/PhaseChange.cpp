...
const std::vector<long long>& PhaseChange::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 6310518169450536016LL;
	return out;
}

const std::vector<short>& PhaseChange::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -8601;
	return out;
}

const std::vector<std::string>& PhaseChange::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "battleship.messages.PhaseChange";
	return out;
}

const std::vector<std::string>& PhaseChange::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "3mc";
	return out;
}
