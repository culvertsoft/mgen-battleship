...
const std::vector<long long>& GameInput::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 20544504380178079LL;
	return out;
}

const std::vector<short>& GameInput::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 31502;
	return out;
}

const std::vector<std::string>& GameInput::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "battleship.messages.GameInput";
	return out;
}

const std::vector<std::string>& GameInput::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "ew4";
	return out;
}
