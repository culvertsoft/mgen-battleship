...
const std::vector<long long>& Snapshot::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 7637425245762246339LL;
	return out;
}

const std::vector<short>& Snapshot::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << -10286;
	return out;
}

const std::vector<std::string>& Snapshot::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "battleship.messages.Snapshot";
	return out;
}

const std::vector<std::string>& Snapshot::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "19I";
	return out;
}
