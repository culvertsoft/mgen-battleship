...
const std::vector<long long>& Login::_type_ids() {
	static const std::vector<long long> out = mgen::make_vector<long long>() << 7755333223434470491LL << 6201271849124169878LL;
	return out;
}

const std::vector<short>& Login::_type_ids_16bit() {
	static const std::vector<short> out = mgen::make_vector<short>() << 11623 << -6764;
	return out;
}

const std::vector<std::string>& Login::_type_names() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "battleship.messages.Connection" << "battleship.messages.Login";
	return out;
}

const std::vector<std::string>& Login::_type_ids_16bit_base64() {
	static const std::vector<std::string> out = mgen::make_vector<std::string>() << "LWc" << "5ZQ";
	return out;
}

const std::string& Login::_type_ids_16bit_base64_string() {
	static const std::string out("LWc5ZQ");
	return out;
}
