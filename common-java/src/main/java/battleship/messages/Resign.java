...
public class Resign extends GameInput /*custom_ifcs_begin*//*custom_ifcs_end*/ {
	...
	public boolean equals(final Object other) {
		...
		if (Resign.class != other.getClass()) return false;
		return true;
	}

	@Override
	public Resign deepCopy() {
		final Resign out = new Resign();
		return out;
	}
 ...
 ********************************************************************************************************************/	 		  
	...
	public Resign _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
		return this;
	}
